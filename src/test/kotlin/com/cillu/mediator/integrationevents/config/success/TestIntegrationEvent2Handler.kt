...
class TestIntegrationEvent2Handler(var testService: ITestService, var anotherService: AnotherService) : IIntegrationEventHandler<TestIntegrationEvent2>, Exception() {
