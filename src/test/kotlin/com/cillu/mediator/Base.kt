...
open class Base()
{
    ...
    fun getMediatorK(configFile: String, registerService: Boolean = true): IMediator {
        ...
        if (registerService) {
            ...
            serviceRegistry.register(ITestService::class.java, MyTestService())
            serviceRegistry.register(ITestService2::class.java, MyTestService2())
            serviceRegistry.register(IAnotherService::class.java, AnotherService())
            serviceRegistry.register(ITestRepository::class.java, MyTestRepository())
